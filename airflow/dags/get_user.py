...
def add_problem_list() -> None:
    ...
    df_user.to_json("/home/kgw7401/user/new_user.json", orient='records', lines=True)


def get_message() -> str:
    return "User Data Upload Success!"

with DAG("get_user", start_date=datetime(2022, 5, 31), 
    ...
    nodes = ['72ef215feedd', '29287d885616', 'f630052b7ae2']
    ...
    add_problem_list = PythonOperator(
        task_id="add_problem_list",
        python_callable=add_problem_list
    )
    ...
    process_user_data >> add_problem_list >> mv_user_local_to_gcs >> check_gcs_user_exists
